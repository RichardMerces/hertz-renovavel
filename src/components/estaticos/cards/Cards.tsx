...
{/* <Grid container alignItems="center" xs={4} justifyContent="center"      >
    <Grid className="card">
        <div className="card-info">
        <Avatar alt="Remy Sharp" src="https://avatars.githubusercontent.com/u/111980974?v=4" />
            
            <div className="card-title">{nome}</div>
            <div className="card-subtitle">Integrante do grupo</div>
        </div>
        <ul className="card-social">
            <li className="card-social__item">
